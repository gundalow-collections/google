...
DOCUMENTATION = '''
---
module: google.gcp.gcp_compute_vpn_tunnel
description:
- VPN tunnel resource.
...
options:
  ...
  target_vpn_gateway:
    ...
    - 'This field represents a link to a TargetVpnGateway resource in GCP. It can
      ...
      name-of-resource` to a google.gcp.gcp_compute_target_vpn_gateway task and then set this
  ...
  router:
    ...
    - 'This field represents a link to a Router resource in GCP. It can be specified
      ...
      to a google.gcp.gcp_compute_router task and then set this router field to "{{ name-of-resource
      }}"'
    required: false
    type: dict
  peer_ip:
