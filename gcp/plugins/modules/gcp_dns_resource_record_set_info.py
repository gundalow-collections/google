...
DOCUMENTATION = '''
---
module: google.gcp.gcp_dns_resource_record_set_info
description:
- Gather info for GCP ResourceRecordSet
- This module was called C(google.gcp.gcp_dns_resource_record_set_facts) before Ansible 2.9.
...
options:
  managed_zone:
    ...
    - Identifies the managed zone addressed by this request. This must be a dictionary
      ...
      of the google.gcp.gcp_dns_managed_zone module, which will contain both.
    required: true
    type: dict
