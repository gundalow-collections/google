...
DOCUMENTATION = '''
---
module: google.gcp.gcp_container_node_pool_info
description:
- Gather info for GCP NodePool
- This module was called C(google.gcp.gcp_container_node_pool_facts) before Ansible 2.9. The
...
options:
  ...
  cluster:
    ...
    - 'This field represents a link to a Cluster resource in GCP. It can be specified
      ...
      to a google.gcp.gcp_container_cluster task and then set this cluster field to "{{ name-of-resource
      }}"'
    required: true
    type: dict
