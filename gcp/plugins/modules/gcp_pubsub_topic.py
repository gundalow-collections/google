...
DOCUMENTATION = '''
---
module: google.gcp.gcp_pubsub_topic
description:
...
options:
  ...
  kms_key_name:
    ...
    - The resource name of the Cloud KMS CryptoKey to be used to protect access to
      messages published on this topic. Your project's PubSub service account (`service-{{PROJECT_NUMBER}}@google.gcp.gcp-sa-pubsub.iam.gserviceaccount.com`)
