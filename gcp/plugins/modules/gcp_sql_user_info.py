...
DOCUMENTATION = '''
---
module: google.gcp.gcp_sql_user_info
description:
- Gather info for GCP User
- This module was called C(google.gcp.gcp_sql_user_facts) before Ansible 2.9. The usage has not
  changed.
...
options:
  instance:
    ...
    - 'This field represents a link to a Instance resource in GCP. It can be specified
      ...
      to a google.gcp.gcp_sql_instance task and then set this instance field to "{{ name-of-resource
      }}"'
    required: true
    type: dict
