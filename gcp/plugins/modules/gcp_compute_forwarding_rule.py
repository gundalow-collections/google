...
DOCUMENTATION = '''
---
module: google.gcp.gcp_compute_forwarding_rule
description:
...
options:
  ...
  backend_service:
    ...
    - 'This field represents a link to a BackendService resource in GCP. It can be
      ...
      name-of-resource` to a google.gcp.gcp_compute_backend_service task and then set this backend_service
  ...
  network:
    ...
    - 'This field represents a link to a Network resource in GCP. It can be specified
      ...
      to a google.gcp.gcp_compute_network task and then set this network field to "{{ name-of-resource
      }}"'
    required: false
    type: dict
  port_range:
  ...
  subnetwork:
    ...
    - 'This field represents a link to a Subnetwork resource in GCP. It can be specified
      in two ways. First, you can place a dictionary with key ''selfLink'' and value
      of your resource''s selfLink Alternatively, you can add `register: name-of-resource`
      to a google.gcp.gcp_compute_subnetwork task and then set this subnetwork field to "{{ name-of-resource
      }}"'
    required: false
    type: dict
  target:
    ...
    - 'This field represents a link to a TargetPool resource in GCP. It can be specified
      in two ways. First, you can place a dictionary with key ''selfLink'' and value
      of your resource''s selfLink Alternatively, you can add `register: name-of-resource`
      to a google.gcp.gcp_compute_target_pool task and then set this target field to "{{ name-of-resource
      }}"'
    required: false
    type: dict
    version_added: 2.7
