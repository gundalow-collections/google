...
DOCUMENTATION = '''
---
module: google.gcp.gcp_compute_route
description:
...
options:
  ...
  next_hop_instance:
    ...
    - 'This field represents a link to a Instance resource in GCP. It can be specified
      in two ways. First, you can place a dictionary with key ''selfLink'' and value
      of your resource''s selfLink Alternatively, you can add `register: name-of-resource`
      to a google.gcp.gcp_compute_instance task and then set this next_hop_instance field to
      "{{ name-of-resource }}"'
    required: false
    type: dict
  next_hop_ip:
  ...
  next_hop_vpn_tunnel:
    ...
    - 'This field represents a link to a VpnTunnel resource in GCP. It can be specified
      in two ways. First, you can place a dictionary with key ''selfLink'' and value
      of your resource''s selfLink Alternatively, you can add `register: name-of-resource`
      to a google.gcp.gcp_compute_vpn_tunnel task and then set this next_hop_vpn_tunnel field
      to "{{ name-of-resource }}"'
    required: false
    type: dict
