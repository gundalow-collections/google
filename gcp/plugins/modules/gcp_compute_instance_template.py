...
DOCUMENTATION = '''
---
module: google.gcp.gcp_compute_instance_template
description:
        ...
        suboptions:
          ...
          source:
            ...
            - 'This field represents a link to a Disk resource in GCP. It can be specified
              ...
              name-of-resource` to a google.gcp.gcp_compute_disk task and then set this source
        ...
        suboptions:
            ...
            suboptions:
              ...
              nat_ip:
                ...
                - 'This field represents a link to a Address resource in GCP. It can
                  ...
                  you can add `register: name-of-resource` to a google.gcp.gcp_compute_address
          ...
          subnetwork:
            ...
            - 'This field represents a link to a Subnetwork resource in GCP. It can
              ...
              can add `register: name-of-resource` to a google.gcp.gcp_compute_subnetwork task
