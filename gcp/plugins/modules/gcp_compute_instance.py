...
DOCUMENTATION = '''
---
module: google.gcp.gcp_compute_instance
description:
    ...
    suboptions:
      ...
      source:
        ...
        - 'This field represents a link to a Disk resource in GCP. It can be specified
          ...
          name-of-resource` to a google.gcp.gcp_compute_disk task and then set this source field
          to "{{ name-of-resource }}"'
        required: false
        type: dict
      type:
    ...
    suboptions:
        ...
        suboptions:
          ...
          nat_ip:
            ...
            - 'This field represents a link to a Address resource in GCP. It can be
              ...
              name-of-resource` to a google.gcp.gcp_compute_address task and then set this nat_ip
      ...
      network:
        ...
        - 'This field represents a link to a Network resource in GCP. It can be specified
          in two ways. First, you can place a dictionary with key ''selfLink'' and
          value of your resource''s selfLink Alternatively, you can add `register:
          name-of-resource` to a google.gcp.gcp_compute_network task and then set this network
          field to "{{ name-of-resource }}"'
        required: false
        type: dict
      network_ip:
      ...
      subnetwork:
        ...
        - 'This field represents a link to a Subnetwork resource in GCP. It can be
          ...
          name-of-resource` to a google.gcp.gcp_compute_subnetwork task and then set this subnetwork
          field to "{{ name-of-resource }}"'
        required: false
        type: dict
  scheduling:
